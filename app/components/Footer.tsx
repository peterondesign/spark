                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                    <div>
                        ...
                        <div className="flex space-x-4">
                            <Link href="https://www.instagram.com/sparkuscc" className="text-gray-600 hover:text-gray-900">
                                ...
                                <span className="sr-only">Instagram: @sparkuscc</span>
                            </Link>
                            <Link href="https://www.tiktok.com/@sparkuscc" className="text-gray-600 hover:text-gray-900">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link href="/date-gift-planning-assistant" className="text-gray-600 hover:text-gray-900">Date Night Box Subscription</Link></li>
